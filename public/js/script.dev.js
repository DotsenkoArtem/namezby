...
function showOrderBtn() {
  ...
  setTimeout(function () {
    if (scrollHeight !== scrollY + document.documentElement.clientHeight) orderBtn.classList.remove("order-btn-fixed_hidden");
  }, 5000);
}
window.addEventListener("scroll", function () {
  scrollHeight === scrollY + document.documentElement.clientHeight ? orderBtn.classList.add("order-btn-fixed_hidden") : orderBtn.classList.remove("order-btn-fixed_hidden");
});
